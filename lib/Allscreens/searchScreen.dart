...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void findPlace(String placeName)async
  {
    if(placeName.length > 1)
      {
        String autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=12345&components=country:lk";
...
class PredictionTile extends StatelessWidget
{
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    showDialog(
      context: context,
      builder: (BuildContext)=>ProgressDialog(message: "searching...\nplease wait...")
    );
